...
import { ResponseAddressInCreateFindPeople } from './response-address-in-create-find-people';

class ResponseCreateFindPeopleWithAddress {
  @ApiProperty({
  ...
  @ApiProperty({
    type: [ResponseAddressInCreateFindPeople],
  })
  address?: ResponseAddressInCreateFindPeople[];
...
export { ResponseCreateFindPeopleWithAddress };
